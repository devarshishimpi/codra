...
const AppShell = React.lazy(() => import('@client/components/layout/app-shell').then(m => ({ default: m.AppShell })));
...
export const withSuspense = (Component: React.ComponentType<any>, isFullPage = false) => (
  <Suspense
    fallback={
      <div
        role="status"
...
export function buildRouter(extra: RouterExtensions = {}) {
  return createBrowserRouter([
    ...
    ...(extra.publicRoutes ?? []),
    {
      element: withSuspense(() => <AppShell navItems={[...defaultNavItems, ...(extra.navItems ?? [])]} />, true),
      errorElement: <RouteErrorBoundary />,
